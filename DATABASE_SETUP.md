...
Esta guía te ayudará a configurar la base de datos de SubliStore en Supabase.

## Pasos para Configurar:

### 1. Accede al Dashboard de Supabase
- Ve a https://supabase.com y accede a tu proyecto
- Navega al SQL Editor
...
### 4. Crea un Administrador
Una vez que la base de datos esté lista:
1. Ve a tu app
2. Haz clic en "Admin"
3. Crea una nueva cuenta (Sign up)
4. Verifica tu email
5. Después de verificar, ejecuta este comando en el SQL Editor:
...
Ahora puedes:
- Ver el marketplace en la página principal
- Acceder al panel de administración en /admin
- Agregar productos, categorías y configurar WhatsApp

¡Disfruta de SubliStore!
